...
score (MkBowlingState frames bonus) = scores' 0 frames (map finToNat bonus)
...
run_tests = do
  ...
  printLn $ score $ MkBowlingState (replicate 10 (Roll 6 4)) [10]
  printLn $ score $ MkBowlingState ([Strike, Strike, Strike, Roll 8 2, Roll 8 0] ++ replicate 5 (Roll 0 0)) []
